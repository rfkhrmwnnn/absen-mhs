<template>
  <div class="animate-fade-in">
    <div class="mb-6 sm:mb-8">
      <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Scan QR Code</h1>
      <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Scan QR Code untuk melakukan absensi</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
      <div class="glass rounded-lg sm:rounded-xl p-4 sm:p-6 card-hover">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm font-semibold mb-1">Total Kehadiran</p>
            <p class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100">{{ myAttendances.length }}</p>
          </div>
          <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center">
      ...
      <div class="glass rounded-lg sm:rounded-xl p-4 sm:p-6 card-hover">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm font-semibold mb-1">Bulan Ini</p>
            <p class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100">{{ monthlyAttendances }}</p>
          </div>
          <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center">
            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="glass rounded-lg sm:rounded-xl p-4 sm:p-6 card-hover sm:col-span-2 lg:col-span-1">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm font-semibold mb-1">Minggu Ini</p>
            <p class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100">{{ weeklyAttendances }}</p>
          </div>
          <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center">
            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
