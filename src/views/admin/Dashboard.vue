    ...
    <aside class="fixed left-0 top-0 h-screen w-64 glass border-r border-gray-200 dark:border-gray-700 z-30">
      <div class="p-6">
        <div class="flex items-center space-x-2 mb-8">
          ...
          <div>
            <h1 class="font-bold text-lg gradient-text">Admin Panel</h1>
        ...
        <nav class="space-y-2">
          <router-link
            ...
            :class="$route.path === '/admin/students' ? 'bg-primary-500 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
            <span class="font-semibold">Data Mahasiswa</span>
          </router-link>

          <router-link
            to="/admin/create-qr"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300"
            :class="$route.path === '/admin/create-qr' ? 'bg-primary-500 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
            </svg>
            <span class="font-semibold">Buat QR Code</span>
          </router-link>

          <router-link
            to="/admin/attendance"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300"
            :class="$route.path === '/admin/attendance' ? 'bg-primary-500 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link
            ...
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300"
            :class="$route.path === '/admin/leave-requests' ? 'bg-primary-500 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
